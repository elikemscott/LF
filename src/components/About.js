    ...
    return (
        <div>
            ...
            <p className="about_profile"> <span>Richard Chapman, ESQ</span>  qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit,
                 sed quia non numquam eius modi tempora incidunt. Et harum quidem rerum facilis est et expedita 
                 distinctio. Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus
                  id quod maxime placeat facere.</p>
  ...
  <div class="card">
    ...
    <div class="card-header" role="tab" id="headingOne1">
      <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="true"
        ...
        <h5 class="mb-0">
          Highly Experienced <i class="fas fa-angle-down rotate-icon"></i>
        </h5>
      </a>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-header" role="tab" id="headingTwo2">
      <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseTwo2"
        ...
        <h5 class="mb-0">
          High Success Rate <i class="fas fa-angle-down rotate-icon"></i>
        </h5>
      </a>
    </div>
  ...
  <div class="card">
    ...
    <div class="card-header" role="tab" id="headingThree3">
      <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree3"
        ...
        <h5 class="mb-0">
          Asset and Time Management <i class="fas fa-angle-down rotate-icon"></i>
        </h5>
      </a>
    </div>
